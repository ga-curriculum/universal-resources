...
2. [Color Info](https://marketplace.visualstudio.com/items?itemName=bierner.color-info)
   - Color Info will provide quick information about the colors you are using in your code. This comes in handy when you are working with CSS and you want to know the color code of a specific color. This includes the color code in HEX, RGB, HSL, and more.
